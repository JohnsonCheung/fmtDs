...
console.log(pad('sdfdfsdklfj lskdf lksdj flsjdf',50,2))
debugger
const zip = (...ay) => {
...
const bdy_$lin_fld = (dr, wdt_ay, align_ay) =>dr.map((v,i)=>pad(v,wdt_ay[i],align_ay[i]))
...
const z =(lin_h1,lin_h2,lin_bdy) => {const h1=lin_h1; return [h1, lin_h2, h1, lin_bdy, h1].join(SEP_LIN)}
